...
![DBoW2-cmake](/ORBSALM2-img/DBoW2-cmake-1.JPG)

接著按`Configure`選擇`Visual Studio 14 2015`，平台選擇`x64`或是你的作業系統而定

![DBoW2-cmake-config](/ORBSALM2-img/DBoW2-cmake-config.JPG)
...
![DBoW2-Properties-1](/ORBSALM2-img/DBoW2-Properties-1.JPG)

接著，到C/C++的Code Generation將`Runtime Library`改成`Multi-threaded(/MT)`

![DBoW2-Properties-2](/ORBSALM2-img/DBoW2-Properties-2.JPG)
...
![g2o-preprocessor](/ORBSALM2-img/g2o-preprocessor.JPG)

選擇好後，建置`ALL_BUILD`，建置成功後如下圖

![g2o-build](/ORBSALM2-img/g2o-build.JPG)
...
![Pangolin-build](/ORBSALM2-img/Pangolin-build.JPG)
...
![ORB_SLAM2_build](/ORBSALM2-img/ORB_SLAM2_build.JPG)
...
![rgbd_dataset_freiburg2_desk](/ORBSALM2-img/rgbd_dataset_freiburg2_desk.JPG)
...
![mono_tum](/ORBSALM2-img/mono_tum.gif)
