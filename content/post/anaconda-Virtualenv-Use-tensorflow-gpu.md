---
title: "Anaconda Virtual Environment Use tensorflow-gpu"
...
![image1](/anaconda-image/image1.PNG)
...
![image2](/anaconda-image/image2.PNG)
## 安裝步驟
#### 1. 安裝Anaconda
...
![image3](/anaconda-image/image3.PNG)

#### 2. 打開Anaconda Prompt

![image4](/anaconda-image/image4.PNG)

#### 3. 建立虛擬環境
在命令列輸入`conda create -n test_env pip python=3.6`，test_env是環境名稱，可以自己取，然後Python的版本是3.6

![image5](/anaconda-image/image5.PNG)

這裡輸入`y`

![image6](/anaconda-image/image6.PNG)

#### 4. 進入虛擬環境
建立完成後，輸入`activate test_env`進入虛擬環境

![image7](/anaconda-image/image7.PNG)

當前方出現自己的環境名稱表示進入成功

![image8](/anaconda-image/image8.PNG)

#### 5. 安裝tensorflow-gpu
輸入`pip install tensorflow-gpu==1.13.1`，安裝版本為1.13.1的tensorflow-gpu

![image9](/anaconda-image/image9.PNG)

#### 6. 安裝 CUDA 10.0
進入此網站 : https://developer.nvidia.com/cuda-toolkit-archive

![image10](/anaconda-image/image10.PNG)

尋找`CUDA 10.0`並安裝

![image11](/anaconda-image/image11.PNG)

一直按`下一步`就安裝完成

![image12](/anaconda-image/image12.PNG)

確認是否有加入環境變數，在Window搜尋`環境變數`

![image13](/anaconda-image/image13.PNG)

CUDA安裝軟體基本上會自動填入路徑

![image14](/anaconda-image/image14.PNG)
...
![image15](/anaconda-image/image15.PNG)

安裝`Window 10`版的

![image16](/anaconda-image/image16.PNG)

下載完檔案後解壓縮會出現3的資料夾與1個文字檔

![image17](/anaconda-image/image17.PNG)

將整個複製到`C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.0`中

![image18](/anaconda-image/image18.PNG)

再進入環境變數看系統變數中的Path中，雙擊兩下可看到系統路徑

![image19](/anaconda-image/image19.PNG)

是否有剛剛複製cuDNN的`bin`與`libnvvp`路徑，基本上系統會自動添加，若沒有需要手動加入

![image20](/anaconda-image/image20.PNG)
...
![image21](/anaconda-image/image21.PNG)

接著輸入`python`

![image22](/anaconda-image/image22.PNG)
...
![image23](/anaconda-image/image23.PNG)
